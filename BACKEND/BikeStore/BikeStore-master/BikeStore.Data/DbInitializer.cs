        ...
        public static void Seed(IServiceProvider serviceProvider)
        {
            ...
            if (!context.BikeModels.Any())
            {
                context.BikeModels.AddRange(
                    // Trek Models
                    new BikeModel(brands[0].Id, "Trek X-Caliber", 100, 0, 800),
                    new BikeModel(brands[0].Id, "Trek Marlin", 120, 0, 650),
                    new BikeModel(brands[0].Id, "Trek Fuel EX", 140, 140, 3000),

                    // Giant Models
                    new BikeModel(brands[1].Id, "Giant Anthem", 110, 110, 1200),
                    new BikeModel(brands[1].Id, "Giant Trance", 150, 150, 2500),

                    // Specialized Models
                    new BikeModel(brands[2].Id, "Specialized Stumpjumper", 140, 140, 2000),
                    new BikeModel(brands[2].Id, "Specialized Epic", 100, 100, 3000),

                    // Canyon Models
                    new BikeModel(brands[3].Id, "Canyon Spectral", 160, 160, 3200),
                    new BikeModel(brands[3].Id, "Canyon Strive", 150, 150, 2800),

                    // Santa Cruz Models
                    new BikeModel(brands[4].Id, "Santa Cruz Hightower", 150, 150, 3500),
                    new BikeModel(brands[4].Id, "Santa Cruz Nomad", 170, 170, 4000),

                    // Yeti Models
                    new BikeModel(brands[5].Id, "Yeti SB150", 150, 150, 5000),
                    new BikeModel(brands[5].Id, "Yeti SB130", 130, 130, 4500),

                    // Scott Models
                    new BikeModel(brands[6].Id, "Scott Spark", 120, 120, 2500),
                    new BikeModel(brands[6].Id, "Scott Genius", 150, 150, 3000),

                    // BMC Models
                    new BikeModel(brands[7].Id, "BMC Fourstroke", 100, 100, 5000),
                    new BikeModel(brands[7].Id, "BMC Speedfox", 130, 130, 3800)
                );
            }
